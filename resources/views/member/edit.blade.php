               ...
               <div class="card-body">
                <form method="POST" action="{{route('member.update',[$member])}}">
                    <div class="form-group">
                      ...
                      <div class="form-group">
                        <label>City</label>
                        <input type="text" class="form-control" name="member_city" value="{{old('member_city', $member->city)}}">
                        <small class="form-text text-muted">Residency of the member</small>
                      </div>
                      <div class="form-group">
                        <label>Experience</label>
                        <input type="number" class="form-control" name="member_experience" value="{{old('member_experience', $member->experience)}}">
                        <small class="form-text text-muted">Years of experience</small>
                      </div>
                      <div class="form-group">
                        <label>Joined</label>
                        <input type="number" class="form-control" name="member_year" value="{{old('member_year', $member->year)}}">
                        <small class="form-text text-muted">Member since</small>
                      </div>
                      <div class="form-group">
                      <label>Notes</label> <textarea name="member_notes">{{old('member_notes', $member->notes)}}</textarea> <small class="form-text text-muted">Any additional information</small></div>
